...
const _routes = [
  {
    name: "BackGroudNumbers",
    path: "/BackGroudNumbers",
    component: () => import('./BackGroudNumbers.vue.mjs')
  },
  {
    name: "BackGroundBlinking",
    path: "/BackGroundBlinking",
    component: () => import('./BackGroundBlinking.vue.mjs')
  },
  {
    name: "index",
    path: "/",
  ...
  },
  {
    name: "mobile",
    path: "/mobile",
    component: () => import('./mobile.vue.mjs')
  },
  {
    name: "navBar",
    path: "/navBar",
    component: () => import('./navBar.vue.mjs')
  }
];
...
const namedMiddleware = {
  "mobile-redirect": () => import('./mobileRedirect.mjs')
};
...
export { _export_sfc as _, useNuxtApp as a, useRuntimeConfig as b, nuxtLinkDefaults as c, defineNuxtRouteMiddleware as d, navigateTo as n, resolveRouteObject as r, server as s, tryUseNuxtApp as t, useRouter as u };
